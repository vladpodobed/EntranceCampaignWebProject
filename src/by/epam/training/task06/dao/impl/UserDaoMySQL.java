...
import by.epam.training.task06.util.daoutil.CertificateDaoQuery;
 ...
 * </p>
 */
public class UserDaoMySQL implements DaoMySQL<User> {
    private static UserDaoMySQL instance = new UserDaoMySQL();
    ...
    public User read(int id) throws DaoException {
        ...
        try {
            ...
            while (result.next()) {
                ...
                List<Certificate> certificates = CertificateDaoMySQL.getInstance().select(certificatesByUserOption);
